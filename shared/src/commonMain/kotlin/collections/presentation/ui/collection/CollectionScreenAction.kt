...
sealed interface CollectionScreenAction {
    ...
    data class ChangeCoinSort(val option: CoinSortOption) : CollectionScreenAction
    data class ChangeSetSort(val option: CoinSetSortOption) : CollectionScreenAction
